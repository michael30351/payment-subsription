...
$oneMonthsLater = $now->copy()->addMonth(1)->format('Y-m-d'); // 日付チェック
...
if($date <= $today || $date > $oneMonthsLater) { // 過去の日付の場合
    $error = "エラーが発生しました。";
}
...
$param = [
    ...
    'CreateMember'            => 1,
    'RetURL'                  => $siteUrl."subscription-payments/bank/callback.php",
    'BankCode'                => $bankCode,
    'BranchCode'              => $branchCode,
    'AccountType'             => $accountType,
    'AccountNumber'           => $accountNumber,
    'AccountName'             => $accountName,
    'AccountNameKanji'        => $name,
    'ConsumerDevice'          => 'pc',
];
