...
<body>
            ...
            <div class="form-area card-form">
                <div class="inner">
                    ...
                    <div class="terms-check-box">
                        ...
                        <div class="box">
                            <div class="link">
                                <span>URL</span><a href="https://applegym.jp/tos/" id="terms-link" class="link-over" target="_blank">利用契約の確認</a>
                            </div>
                    ...
                    <form method="post" name="formName" id="form">
                        ...
                        <div class="input-area">
                            ...
                            <div class="input">
                                ...
                                <label for="S20" class="plan-label link-over">
                                    ...
                                    <span id="price_S20"><b>¥9,000</b>（税込 ¥9,900）</span>
                                </label>
                                ...
                                <label for="M20" class="plan-label link-over">
                                    ...
                                    <span id="price_M20"><b>¥18,000</b>（税込 ¥19,800）</span>
                                </label>
                                ...
                                <label for="L20" class="plan-label link-over">
                                    ...
                                    <span id="price_L20"><b>¥27,000</b>（税込 ¥29,700）</span>
                                </label>
                                ...
                                <label for="S40" class="plan-label link-over">
                                    ...
                                    <span id="price_S40"><b>¥18,000</b>（税込 ¥19,800）</span>
                                </label>
                                ...
                                <label for="M40" class="plan-label link-over">
                                    ...
                                    <span id="price_M40"><b>¥36,000</b>（税込 ¥39,600）</span>
                                </label>
                                ...
                                <label for="L40" class="plan-label link-over">
                                    ...
                                    <span id="price_L40"><b>¥54,000</b>（税込 ¥59,400）</span>
                                </label>
                        ...
                        <div class="input-area">
                            ...
                            <div class="input">
                                ...
                                ※固定費用として、共用設備費 ¥300/月（税込 ¥330）がかかります。
                            </div>
                        </div>
                        <div class="input-area">
                            <div class="headline">
    ...
    (function($) {
        $(function() {
            ...
            // termsを確認したかのチェック
            const terms_checkbox = $('#terms');  // 利用規約チェック判定
            // 初期ロード時にsessionStorageを確認
            if (sessionStorage.getItem('terms_checkbox_enabled') === 'true') {
                terms_checkbox.prop('disabled', false);
            }
            // 利用規約をクリックでdisabledを解除 + sessionStorage保存
            $('#terms-link').on('click', function(e) {
                terms_checkbox.prop('disabled', false); // disabled解除
                sessionStorage.setItem('terms_checkbox_enabled', 'true'); // 状態を保存
            });
